...
The pipeline has been applied to the **KIV-2 VNTR** of the **LPA gene** (using a novel signature-sequence approach) but can be used for **other similar VNTRs** by specifying a region for read extraction.
